...
namespace java org.apache.sentry.provider.db.genericModel.service.thrift
namespace php sentry.provider.db.service.db.genericModel.serivce.thrift
namespace cpp Apache.Sentry.Provider.Db.GenericModel.Service.Thrift
...
6: optional i64 createTime, # Set on server side
7: optional string grantorPrincipal, # Set on server side
8: optional TSentryGrantOption grantOption = sentry_policy_service.TSentryGrantOption.FALSE
}
