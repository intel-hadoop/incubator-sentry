...
/**
 * SentryHAClientFactory is a factory to get the Client support high availability.
 */
public class SentryHAClientFactory<T extends SentryPolicyServiceBaseClient> implements SentryServiceClientFactory<T> {
  ...
  public SentryHAClientFactory(Configuration conf, SentryServiceClientFactory<T> factory, Class<T> typeParameterClass) {
    this.conf = conf;
