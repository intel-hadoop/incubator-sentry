...
public class PoolSentryServiceClientFactory<T extends SentryPolicyServiceBaseClient> implements SentryServiceClientFactory<T> {
  ...
  private PoolSentryServiceClientFactory() {
    typeParameterClass = null;
  }

  public PoolSentryServiceClientFactory(Configuration conf, SentryServiceClientFactory<T> factory, Class<T> typeParameterClass) {
    this.conf = conf;
