...
public class TestSentryHiveAuthorizerFactory {
  ...
  public void testCreateHiveAuthorizer() throws Exception {
    conf.set(SentryHiveAuthorizerFactory.HIVE_SENTRY_ACCESS_CONTROLLER,
        TestSentryAccessController.class.getName());
    conf.set(SentryHiveAuthorizerFactory.HIVE_SENTRY_AUTHORIZATION_CONTROLLER,
        TestSentryAuthorizationValidator.class.getName());
    HiveAuthenticationProvider authenticator = new HadoopDefaultAuthenticator();
    SentryHiveAuthorizerFactory factory = new SentryHiveAuthorizerFactory();
    HiveAuthorizer authorizer = factory.createHiveAuthorizer(null, conf, authzConf, authenticator);
    ...
    authorizer.checkPrivileges(null, null, null);
